...
data class LoadSwitchFilter(val switchId :  UUID? = null )

class FindSwitchQuery(val filter: LoadSwitchFilter = LoadSwitchFilter()) {
    override fun toString(): String = "LoadSwitchQuery"
}

class FindAllSwitchQuery() {
    override fun toString(): String = "LoadAllSwitchQuery"
}

data class SwitchFetchOneSummary(@Id var switchId : UUID? = null) {
}
