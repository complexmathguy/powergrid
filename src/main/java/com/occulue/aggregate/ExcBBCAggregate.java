...
public class ExcBBCAggregate {  
    ...
    public ExcBBCAggregate(CreateExcBBCCommand command) throws Exception {
    	...
    	CreateExcBBCEvent event = new CreateExcBBCEvent(command.getExcBBCId(), command.getEfdmax(), command.getEfdmin(), command.getK(), command.getSwitch(), command.getT1(), command.getT2(), command.getT3(), command.getT4(), command.getVrmax(), command.getVrmin(), command.getXe());
    ...
    public void handle(UpdateExcBBCCommand command) throws Exception {
    	...
    	UpdateExcBBCEvent event = new UpdateExcBBCEvent(command.getExcBBCId(), command.getEfdmax(), command.getEfdmin(), command.getK(), command.getSwitch(), command.getT1(), command.getT2(), command.getT3(), command.getT4(), command.getVrmax(), command.getVrmin(), command.getXe());        
