...
import ListSwitchComponent from './components/ListSwitchComponent';
import CreateSwitchComponent from './components/CreateSwitchComponent';
import UpdateSwitchComponent from './components/UpdateSwitchComponent';
import ViewSwitchComponent from './components/ViewSwitchComponent';
                ...
                <div className="container">
                    <Switch>
                          ...
                          {/* <Route path = "/update-svVoltage/:id" component = {UpdateSvVoltageComponent}></Route> */}
                            <Route path = "/switchs" component = {ListSwitchComponent}></Route>
                            <Route path = "/add-switch/:id" component = {CreateSwitchComponent}></Route>
                            <Route path = "/view-switch/:id" component = {ViewSwitchComponent}></Route>
                          {/* <Route path = "/update-switch/:id" component = {UpdateSwitchComponent}></Route> */}
